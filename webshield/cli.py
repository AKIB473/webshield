"""
WebShield CLI — Entry point (v1.2.0)
"""
...
@click.group()
@click.version_option("1.2.0", prog_name="webshield")
def cli():
...
def list_modules():
    ...
    table = Table(title="WebShield Modules (v1.2.0)", box=box.ROUNDED, show_lines=True)
